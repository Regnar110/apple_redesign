        ...
        </div>
        {
            items.length > 0 && (
              <div className='mx-5 md:mx-8'>
                ...
                <div className='my-12 mt-6 ml-auto max-w-full'>
                    ...
                    <div className="flex flex-col gap-4 md:flex-row">
                      <div className="order-2 flex flex-1 flex-col items-center rounded-xl bg-gray-200 p-8 py-12 text-center">
                        <h4 className="mb-4 flex flex-col text-xl font-semibold">
                          ...
                          <span>
                            $ 299,99 per month<sup className='-top-1'>◊</sup>
                          </span>
                        </h4>
                      ...
                      <div className='flex flex-1 flex-col items-center space-y-8 rounded-xl
                        bg-gray-200 p-8 py-12 md:order-2'>
                        <h4 className='mb-2 flex flex-col text-xl font-semibold'>
                          Pay in full
                          <span>
                            $ {totalPrice},00
                          </span>
